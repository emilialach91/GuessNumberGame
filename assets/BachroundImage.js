...
const BacgroundImage = (props) => (
	<Svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500" {...props}>
		<Path fill="#CEDCD9" d="M0 0h2000v1500H0z" />
		<Defs>
			<RadialGradient id="c" gradientUnits="objectBoundingBox">
				<Stop offset={0} stopColor="#E7E8E7" />
				<Stop offset={1} stopColor="#CEDCD9" />
			</RadialGradient>
			<LinearGradient
				id="a"
		...
		<G>
			...
			<Circle fillOpacity={0.1} fill="url(#c)" r={3000} />
		</G>
	</Svg>
)
